...
function fn_verif_perawat(registrasi){
  var r = confirm("Yakin akan mengirimkan catatan anda ke dokter?"+"\n"+"Setelah dikirim, hasil tidak bisa anda edit lagi."+"\n"+"Dokter akan mulai isi hasil pemeriksaan");
  var APP_URL = $('meta[name="_base_url"]').attr('content');
  ...
  if (r == true) {
    ...
    $.ajax({
      ...
      url: APP_URL+'/hasilmcu/kirimkedokter',
          type: "POST",
          dataType: 'json',
          success: function (data) {
