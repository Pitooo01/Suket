...
@section('title', 'Surat Keterangan Bekerja')
...
@section('content')
                ...
                <table class="table table-sm">
                    <tr>
                        ...
                        <td><input type="text" id="nosurat" name="nosurat" style="width: 5%;"> / <input type="text"
                                value="RSAB-SDM/" style="border: none;outline: none;width: 8%;"><select id="bulan"
                                name="bulan">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td><select id="keperluansurat" name="keperluansurat" class="form-control select2"
                                style="width: 45%;">>
                                <option selected="selected">-- Pilih Keperluan Surat --</option>
                                @foreach ($keperluan_surat as $keperluan_surats)
                                    <option value="{{ $keperluan_surats->KeperluanSuratID }}">{{ $keperluan_surats->Nama }}
                                    </option>
                                @endforeach
                            </select></td>
                    </tr>
    ...
    <diV class="w3-center" id="simpan">
        <input type="button" id="btn_simpan_data" class="w3-btn w3-round-medium w3-indigo w3-large" value="Simpan"
            onclick="fn_tambah_suket_bekerja()" />

        <a href="{{ url('/keteranganbekerja') }}" class="w3-btn w3-round-small w3-red w3-large">Kembali</a>
    </diV>
    ...
    <script>
        $(function() {
            ...
            $("#keperluansurat").keydown(function(e) {
                if (e.keyCode == 13) {
                    $("#email").focus();
                }
            });
        ...
        function fn_tambah_suket_bekerja() {
            ...
            var keperluansurat = $("#keperluansurat ").val();
            var email = $("#email ").val();
            //alert(sekarang);
            if (nosurat == "") {
                swal({
            ...
            } else if (keperluansurat == "-- Pilih Keperluan Surat --") {
                swal({
                    title: "error!",
                    text: "Keperluan surat masih kosong",
                    type: "error",
                    timer: 2000,
                    confirmButtonText: "Tutup",
                });
