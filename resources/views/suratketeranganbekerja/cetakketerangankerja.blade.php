...
<body>
    ...
    <table border='0' width='185px' align=center>
        <tr>
            <td style="bold;font-size:17px;font-family: Arial, Helvetica, sans-serif;" width='390px' align='center'><b><u>SURAT KETERANGAN</u></b><br />
                <p style="margin-top: 3px; font-size: 13px">No. {{ @$cetakketerangankerja[0]->SuketKeteranganID }}</p>
            </td>
        </tr>
    </table>
    ...
    <div style="padding-left: 80px">
        <table border='0' width='70%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                ...
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankerja[0]->NIK }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Nama
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankerja[0]->NamaKarywan }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Tempat/Tgl Lahir
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankerja[0]->TempatLahir }} / {{ @$tgllahir }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Bagian/Jabatan
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankerja[0]->Bagian }} / {{ @$cetakketerangankerja[0]->Jabatan }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
    ...
    <div style="margin-left: 30px;margin-right: 50px;">
        <table width='100%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='100%' class="justify">Adapun surat keterangan ini dibuat dengan maksud untuk melengkapi persyaratan {{ @$keperluansurat[0]->Nama }} yang bersangkutan. Mohon kiranya yang bersangkutan dapat dibantu dalam kelancaran pengurusan tersebut.
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="position:absolute; top: 538px; left: 30px; width:5px; height:5px;  opacity: 1;">
        <img src="{{ asset('image/ttdichabiru.png') }}" style="width:170px; height:80px;">
    </div>

    <div style="position:absolute; top: 545px; left: 48px; width:5px; height:5px;  opacity: 2;">
