...
@section('title', 'Ubah Nama Jabatan')
        ...
        <div class="row">
            <table class="table table-sm">
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td><input type="text" id="namajabatan" name="namajabatan" value="{{$jabatan[0]->NamaJabatan}}" style="width: 35%;"><input type="hidden" id="idjabatan" name="idjabatan" value="{{ encrypt($jabatan[0]->ID) }}" style="width: 35%;" readonly></td>
                </tr>
            </table>
        </div>
    </div>
        ...
        if (namajabatan == "") {
            ...
            $.ajax({
                ...
                success: function(data) {
                        ...
                        $("#namajabatan").val("");
                        $("#idjabatan").val("");
                        window.location.href = APP_URL + "/jabatan";
                },
                error: function(data) {
