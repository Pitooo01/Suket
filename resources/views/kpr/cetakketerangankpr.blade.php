...
<body>
    ...
    <table border='0' width='185px' align=center>
        <tr>
            <td style="bold;font-size:17px;font-family: Arial, Helvetica, sans-serif;" width='390px' align='center'><b><u>SURAT KETERANGAN</u></b><br />
                <p style="margin-top: 3px; font-size: 13px">No. {{ @$cetakketerangankpr[0]->SuketKeteranganKprID }}</p>
            </td>
        </tr>
    </table>
    ...
    <div style="padding-left: 80px">
        <table border='0' width='70%'>
            <tr style=font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                ...
                <td width='2%'>:</td>
                <td width='50%'>{{ @$namasdm }}</td>
            </tr>
            <tr style=font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Jabatan
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$keteranganjabatan }}</td>
            </tr>
        </table>
    </div>
    ...
    <div style="padding-left: 80px">
        <table border='0' width='70%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                ...
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankpr[0]->NIK }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Nama
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankpr[0]->NamaKarywan }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Tempat/Tgl Lahir
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankpr[0]->TempatLahir }} / {{ @$tgllahir }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='25%'>Bagian/Jabatan
                </td>
                <td width='2%'>:</td>
                <td width='50%'>{{ @$cetakketerangankpr[0]->Bagian }} / {{ @$cetakketerangankpr[0]->Jabatan }}</td>
            </tr>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
    ...
    <div style="margin-left: 30px;margin-right: 50px;">
        <table border='0' width='100%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='100%' class="justify">Adalah benar yang bersangkutan masih bekerja di Rumah Sakit {{ $namars }} sejak tanggal {{ @$tglmasuk }} sampai dengan {{ @$tglkeluar }}.
                </td>
            </tr>
        </table>
    </div>
    <div style="margin-left: 30px;margin-right: 50px;">
        <table width='100%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='100%' class="justify">Adapun surat keterangan ini dibuat dengan maksud untuk melengkapi persyaratan pengambilan Kredit Pemilikan Rumah (KPR) di {{ $namabank->NamaBank }}, selanjutnya segala sesuatu hal yang diakibatkan masalah hutang yang bersangkutan adalah bukan tanggung jawab RS {{ $namars }}. Mohon kiranya yang bersangkutan dapat dibantu dalam kelancaran pengurusan tersebut.
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="padding-top: 25px;margin-left: 30px">
        <table width='80%'>
            <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                <td width='50%' class="justify">{{ $kota }}, {{ $tglcetak }} <br />RS {{ $namars }}<br /><br /><br /><u>{{ @$namasdm }}</u><br />{{ @$keteranganjabatan }}</td>
