...
@section('title', 'Tambah Nama Bank KPR')

@section('content')
<meta name="csrf-token" content="{{ csrf_token() }}" />
<meta name="_base_url" content="{{ url('/') }}">

<form id="frm_tambah_namabank" name="frm_tambah_namababk">
    <div class="card-body">
        <div class="row">
            <table class="table table-sm">
                <tr>
                    ...
                    <td style="width: 1%;">:</td>
                    <td><input type="text" id="namabank" name="namabank" style="width: 35%;"></td>
                </tr>
            </table>
        </div>
    </div>
