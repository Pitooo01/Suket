        ...
        <tr>
            <td style=bold;font-size:17px;font-family: Arial, Helvetica, sans-serif; width='390px' align='center'><b><u>SURAT PENGALAMAN KERJA</u></b><br/>
                ...
                <div style="margin-left: 50px;margin-right: 50px;">
                    <table border='0' width='100%'>
                        <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                            <td width='100%' class="justify"><p>Adalah  benar  pernah bekerja di RS Awal Bros Ujung Batu sejak  tanggal  {{ $awal }} s.d {{ $akhir }} dengan jabatan terakhir sebagai {{ @$cetakpengalaman[0]->JabatanAkhir }} Rumah Sakit Awal Bros Ujung Batu. </p><p style="margin-top: -15px;"><i>He/She was a permanent employee in this company and working since {{ $awaleng }} until {{ $akhireng }} with his last position as {{ @$cetakpengalaman[0]->JabatanAkhir }}.</i></p></td>
                        </tr>
                    </table>
                </div>
                <div style="margin-left: 50px;margin-right: 50px;">
                    <table border='0' width='100%'>
                        <tr style=bold;font-size:14px;font-family: Arial, Helvetica, sans-serif;>
                            <td width='100%' class="justify">Manajemen mengucapkan terima kasih untuk kerjasama yang baik selama bekerja di Rumah Sakit Awal Bros Ujung Batu.<p style="margin-top: -5px;"><i>For his dedication and good conduct while working with us, we thank you.</i></p></td>
                        </tr>
                    </table>
                </div>
                <div style="margin-left: 50px;margin-right: 50px;">
                ...
                <div style="position:absolute; top: 798px; left: 48px; width:5px; height:5px;  opacity: 2;">
