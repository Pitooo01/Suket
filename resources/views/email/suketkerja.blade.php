...
<body>
  ...
  <p>Berikut kami kirimkan surat Keterangan anda. Terima kasih</p>
  ...
  <div>
    <table border='0' width='0px' align=center>
      <tr style=bold;font-size:19px;>
        ...
        <td width='2px'>:</td>
        <td width='350px' height=5px>{{$header[0]->SuketKeteranganID}}</td>
      </tr>
      <tr style=bold;font-size:19px;>
    ...
    <p> <a href="{{ $ip->IP }}/new_suket/keteranganbekerja/email/{{$header[0]->SEO}}">Klik Disini Untuk Download Surat Keterangan Kerja Anda.</a> </p>
  </div>
</body>
